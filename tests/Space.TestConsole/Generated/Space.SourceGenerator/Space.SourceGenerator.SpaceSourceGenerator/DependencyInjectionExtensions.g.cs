    ...
    public static class SourceGeneratorDependencyInjectionExtensions
    {
        ...
        private static IServiceCollection AddSpaceInternal(IServiceCollection services, SpaceOptions options)
        {
            ...
            services.AddSingleton<SpaceRegistry>(sp =>
            {
                ...
                // New: notifications registrar using runtime singleton flag
                ...
                // Handlers / Pipelines / Modules
                                ...
                                Reg<global::TestHandler, global::UserCreateCommand, global::UserCreateResponse>("",
                                    (inst, ctx) =>  inst.Handle(ctx) );
                
                                    
                
                                    
                                        RegModule<global::UserCreateCommand, global::UserCreateResponse>("", "AuditModuleAttribute", "");
